...
This Assignment creates the standalone planning runtime, its contracts, agent
interface, doctors, skills, examples, and verification surfaces.

The completed foundation slice is tracked in
[`exec-plans/completed/2026-07-13-portable-foundation.md`](exec-plans/completed/2026-07-13-portable-foundation.md).

The completed documentation-spine slice is tracked in
[`exec-plans/completed/2026-07-13-docs-spine.md`](exec-plans/completed/2026-07-13-docs-spine.md).
